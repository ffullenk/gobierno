     ...
     <td height="400" valign="top"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="left" background="imagenes/bckimg-1.png" class="texto-tsiscab">&nbsp;B&uacute;squeda 
            de Tesis &nbsp;por <strong>&Aacute;rea de Tesis</strong>, mostrar resultados</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
...
if( (!$HTTP_GET_VARS[s]) || ($HTTP_GET_VARS[s] == "b") ) {
  tsiscab(); ?>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<?php
			$res = mysql_query("SELECT area FROM area WHERE idarea='$carea'") or die(mysql_error());
			if($flarea=mysql_fetch_object($res)) {
			   echo $flarea->area;
			}
			mysql_free_result($res); unset($flarea);
			?>
			</strong></td></tr>
...
<?php
   ...
   {?> <tr><td height="10" valign="middle" class="info" style="padding-left:2px;"><div id="lin-sup">mostrar m&aacute;s registros en p&aacute;gina <?php
      for ($i=$minimo; $i<$pg; $i++){
         echo "<a href='".$HTTP_SERVER["PHP_SELF"]."?s=b&carea=".$carea."&pg=".$i."'>$i</a>&nbsp;";
      }
   ...
   if($pg<$total_paginas)
   {
     echo "&nbsp;<a href='".$HTTP_SERVER["PHP_SELF"]."?s=b&carea=".$carea."&pg=" .($pg+1). "'>";
