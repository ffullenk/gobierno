     ...
     <td height="400" valign="top"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="left" background="imagenes/bckimg-1.png" class="texto-tsiscab">&nbsp;B&uacute;squeda 
            de Tesis &nbsp;<?php
				echo "por Palabra en <strong>T&iacute;tulo de Tesis</strong>, mostrar resultados";
				?></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
...
if( (!$HTTP_GET_VARS[s]) || ($HTTP_GET_VARS[s] == "b") ) {
  tsiscab(); ?>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<?php echo " palabra <strong>".$ctitulo."</strong>";?>
			</td></tr>
              ...
              /* examino la página a mostrar y el inicio del registro a mostrar */
                 ...
                 /* construyo la sentencia SQL */
                    ...
                    while ($fila=mysql_fetch_object($rs)) { ?>                                                        
						   <tr>
						     <td class="secc-ppal" bgcolor="#F2F2F2">
						      <table border="0" cellpadding="0" cellspacing="0">
								...
								<tr>
								  <td class="texto-peq">A&ntilde;o Edici&oacute;n</td><td class="secc-ppal">:</td>
								  <td class="texto-peq" align="left"><font color="#5475C6"><?php echo $fila->anno;?></font></td>
								</tr>
							  </table>
							...
							<tr><td colspan="5" height="5" style="padding-left:2px;"></td></tr>
...
<?php
   ...
   {?> <tr><td height="10" valign="middle" class="info" style="padding-left:2px;"><div id="lin-sup">mostrar m&aacute;s registros en p&aacute;gina <?php
      for ($i=$minimo; $i<$pg; $i++){
         echo "<a href='".$HTTP_SERVER["PHP_SELF"]."?s=b&ctitulo=".$ctitulo."&pg=".$i."'>$i</a>&nbsp;";
      }
   ...
   if($pg<$total_paginas)
   {
     echo "&nbsp;<a href='".$HTTP_SERVER["PHP_SELF"]."?s=b&ctitulo=".$ctitulo."&pg=" .($pg+1). "'>";
