     ...
     <td height="400" valign="top"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr> 
          <td align="left" background="imagenes/bckimg-1.png" class="texto-tsiscab">&nbsp;B&uacute;squeda 
            de Tesis &nbsp;por <strong>Instituci&oacute;n</strong>, mostrar resultados</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			if($cinst != "x" ) {
               ...
               if($flinst=mysql_fetch_object($res)) {
			      echo $flinst->institucion;
			   }
               mysql_free_result($res); unset($flinst);
			} else { echo "Todas las Instituciones"; }
			?>
			</strong></td></tr>
<?php           // Paginacion de Registros de Tabla Noticias
              ...
              /* examino la página a mostrar y el inicio del registro a mostrar */
				 ...
				 /* ve condiciones segun parametro de busqueda */
					if( $cinst != "x" ) {
                        $ssql = "SELECT idtesis, tipo, area, titulo, anno FROM tesis INNER JOIN tipo ON tesis.idtipo=tipo.idtipo INNER JOIN area ON tesis.idarea=area.idarea";
					    $ssql.= " WHERE idinst='$cinst' ORDER BY anno DESC";
					} else { 
                        $ssql = "SELECT idtesis, tesis.idinst, institucion, tipo, area, titulo, anno FROM tesis INNER JOIN institucion ON tesis.idinst=institucion.idinst INNER JOIN tipo ON tesis.idtipo=tipo.idtipo INNER JOIN area ON tesis.idarea=area.idarea";
					    $ssql.= " ORDER BY tesis.idinst";
					}
                 $rs = mysql_query($ssql);
                    ...
                    <tr>
					   <td class="secc-ppal" colspan="5">
                         <table border="0" cellpadding="0" cellspacing="0" width="100%">
                           <tr>
						      <td colspan="2" class="texto-tsisr"><div id="lin-all">Instituci&oacute;n&nbsp;&nbsp;
							      <font color="#5475C6"><strong><?php echo $fila->institucion;?></strong></font></div></td>
                           </tr>
						   <?php $vcinst = $fila->idinst;
						   while( $vcinst == $fila->idinst ) { ?>
						    ...
						    <tr><td class="info">&Aacute;rea&nbsp;&nbsp;<font color="#5475C6"><?php echo $fila->area;?></font></td></tr>
						    <tr><td class="info"><strong><?php echo $fila->titulo;?></strong></td></tr>
						     ...
						     <td class="secc-ppal">
						      <table border="0" cellpadding="0" cellspacing="0">
							    <tr>
								  ...
								  <td class="texto-peq" align="left"><font color="#5475C6"><?php echo $fila->tipo;?></font></td>
								</tr>
								<tr>
...
<?php
   ...
   {?> <tr><td height="10" valign="middle" class="info" style="padding-left:2px;"><div id="lin-sup">mostrar m&aacute;s registros en p&aacute;gina <?php
      for ($i=$minimo; $i<$pg; $i++){
         echo "<a href='".$HTTP_SERVER["PHP_SELF"]."?s=b&cinst=".$cinst."&pg=".$i."'>$i</a>&nbsp;";
      }
   ...
   if($pg<$total_paginas)
   {
     echo "&nbsp;<a href='".$HTTP_SERVER["PHP_SELF"]."?s=b&cinst=".$cinst."&pg=" .($pg+1). "'>";
