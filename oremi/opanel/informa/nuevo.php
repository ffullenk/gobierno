...
echo "
			...
			<div id=\"informeForm\">
			    <H5>Formulario Ingreso Informe Period&iacute;stico</H5>
			    <form action=\"graba.php\" method=\"post\" name=\"formulario\" id=\"formulario\" onsubmit=\"return vldInforme();\" >
...
<tr><td>(*) Materia:</td>
	<td><input type=\"text\" name=\"titulo\" size=\"75\" maxlength=\"250\"  /></td>
</tr>

<tr><td colspan=\"2\" height=\"15\"></td></tr>

<tr><td>(*) Fecha</td>
	<td><input type=\"text\" name=\"fecha\" size=\"10\" maxlength=\"10\" value=\"$fecha_\" onchange=\"return ValidaFecha2(this.value);\">&nbsp;
...
<tr><td>(*) Descripci&oacute;n</td>
	<td><textarea name=\"observaciones\" rows=\"7\" cols=\"50\"></textarea></td>
</tr>
...
<tr><td colspan=\"2\" height=\"25\"></td></tr>
<tr><td colspan=\"2\" align=\"center\"><input type=\"submit\" value=\" Grabar Informe\" name=\"nuevo\" class=\"submit\" /></td></tr>
</table>
</form>
			</div>";
	   ?>
