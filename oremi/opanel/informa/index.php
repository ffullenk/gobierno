...
<input type=\"submit\" class=\"crea\" value=\" Nuevo Informe \" />
</form>
		  ...
		  <div id=\"tablaRegistros\">
			  <table border=\"0\" cellpadding=\"3\" cellspacing=\"1\" >";
				...
				$sqlInf = "SELECT INFORMATIVO_ID, MATERIA, FECHA, NROINFORME 
								FROM INFORMATIVO 
								WHERE ENCARGADO_ID=\"$global_qk\" ";
				$rsInf->Open($sqlInf);
				$num_total_registros = $rsInf->RecordCount();
				if( $num_total_registros > 0 ) {
					...
					$sqlInf.= " LIMIT ". $inicio . "," . $TAMANO_PAGINA .";";
					$rsInf->Open($sqlInf);
					echo "<tr><th class=\"tituloTabla\">Nro.Informe</th><th class=\"tituloTabla\">Materia</th><th class=\"tituloTabla\">Fecha</th><td colspan=\"2\"></td></tr>";
					$colorbg = "#F5F5F5";
					$i=0;
					while($rsInf->moveNext() ) { 
					
						if($i%2==0) { echo "<tr bgcolor=\"#F5F5F5\" valign=\"middle\">";} else {echo "<tr bgcolor=\"#ffffff\" valign=\"middle\">";}
						$i++;?>
						
<td class="contenido"><?php echo $rsInf->FieldByNumber(3); ?></td>
<td class="texto-contenido"><?php echo  $rsInf->FieldByNumber(1);?></td>
<td class="texto-contenido"><?php echo  fechaNuestra($rsInf->FieldByNumber(2));?></td>

<form action="edita.php" method="post" name="edita" id="edita">
<td align="center">
<input type="hidden" name="id" value="<?php echo $rsInf->FieldByNumber(0);?>" />
