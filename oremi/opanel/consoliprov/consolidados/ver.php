...
<p align=\"center\"><span style=\"font-size:14pt; font-family:Georgia,Verdana;line-height:18pt;\">Consolidados Provinciales para el Evento<br />
			  ...
			  <table border=\"0\" cellpadding=\"3\" cellspacing=\"1\" >";
				...
				$sqlAlfas = "SELECT CONSOLIDAPROV_ID, TITULOEVENTO, FECHA, HORA 
								FROM CONSOLIDAPROV  
...
<td class="texto-contenido"><?php echo $rsAlfas->FieldByNumber(1);?></td>

<td class="texto-contenido"><?php echo fechaNuestra($rsAlfas->FieldByNumber(2)) ." ".$rsAlfas->FieldByNumber(3);?></td>

<form action="../ver/muestra.php" method="post" name="edita" id="edita" target="_blank">
<td align="center">
<input type="hidden" name="id" value="<?php echo $id;?>" />
<input type="hidden" name="consp" value="<?php echo $rsAlfas->FieldByNumber(0);?>" />
