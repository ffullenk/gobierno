...
?>
    <div >
	   ...
	   <?php
		...
		$ssql = "SELECT EVENTOPROVINCIA_ID, NRO_EVENTOS, TITULOEVENTO, FECHA_INICIO, HORA_INICIO, ESTADOEVENTO_ID 
	  			FROM EVENTOPROVINCIA AS A
...
<p style=\"background-color:#F0E9E1; padding:5px; border:1px solid #fff;font-family:Arial,Verdana; font-size:10pt;\">Usted visualiza en estos momentos, los <strong>Consolidados Provinciales</strong> que ha creado en el tiempo.</p>
			...
			<div id=\"tablaRegistros\">
			  <table border=\"0\" cellpadding=\"3\" cellspacing=\"1\" >";
				...
				if( $num_total_registros > 0 ) {
					...
					$rsEventos->Open($ssql);
					echo "<tr><th class=\"tituloTabla\">Evento</th><th class=\"tituloTabla\">Estado</th><th class=\"tituloTabla\">".$_aEventoColumna[$global_cg]."</th><th class=\"tituloTabla\">Ocurrencia</th><td >&nbsp;</tr>";
					$colorbg = "#F5F5F5";
					$i=0;
					while($rsEventos->moveNext() ) { 
						...
						$i++;?>
							...
							<td class="texto-contenido" align="center"><?php echo $_aEstado[$rsEventos->FieldByNumber(5)];?></td>
...
<form action="ver.php" method="post" name="edita" id="edita">
<td align="center">
