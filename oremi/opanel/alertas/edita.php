	  ...
	  echo "
			...
			<Script language=\"JavaScript\" src=\"../js/calendar1.js\" type=\"text/javascript\"></Script>
 			  ...
 			  <div id=\"informeForm\">
			    ...
			    <form action=\"actualiza.php\" method=\"post\" name=\"formulario\" id=\"formulario\" onsubmit=\"return vldAlerta();\" >
				<input type=\"hidden\" name=\"id\" value=\"".$rsSQL->FieldByNumber(0)."\" />
				<dl>
				<fieldset>
				   <legend>Centro de Alerta</legend>
				      <dt>Fecha:</dt>
					  <dd>
<input type=\"text\" name=\"fecha\" size=\"10\" maxlength=\"10\" value=\"".fechaNuestra($rsSQL->FieldByNumber(1))."\" onchange=\"return ValidaFecha2(this.value);\">&nbsp;
						<a href=\"javascript:cal1.popup();\"><img src=\""._imagenesPanel_."cal.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Fecha de la Alerta \"></a>"; ?>
...
echo "
					  ...
					  <dd><textarea name=\"situacion\" rows=\"10\" cols=\"65\" >".$rsSQL->FieldByNumber(7)."</textarea></dd>

				      <dt>Orientaci&oacute;n para la Gesti&oacute;n de Protecci&oacute;n Civil:</dt>
					  <dd><textarea name=\"orientacion\" rows=\"10\" cols=\"65\" >".$rsSQL->FieldByNumber(8)."</textarea></dd>
</fieldset>
