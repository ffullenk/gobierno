...
if(existenRegistros("ALERTA_ID","ALERTAS")) {
    ...
    echo "
		<div id=\"mconregistro\">
			...
			<form action=\"nuevo.php\" method=\"post\" name=\"nuevo\" id=\"nuevo\" >
			  <input type=\"submit\" value=\" Nueva Alerta \" class=\"crea\" align=\"right\" />
			</form>
			...
			<div id=\"tablaRegistros\">
			  <table  border=\"0\" cellpadding=\"3\" cellspacing=\"1\" >";
				...
				if( $num_total_registros > 0 ) {
					...
					$rsSQL->Open($ssql);
					echo "<tr><th class=\"tituloTabla\">Grado</th><th class=\"tituloTabla\">Fecha</th><th class=\"tituloTabla\">Variable</th><th class=\"tituloTabla\">Zona</th><td colspan=\"2\">&nbsp;</tr>";
...
<form action="edita.php" method="post" name="edita" id="edita">
<td align="center">
