...
?>
    <div >
	   ...
	   <?php
		...
		$sqlEvento = "SELECT EVENTOREGION_ID, TITULOEVENTO FROM EVENTOREGION WHERE EVENTOREGION_ID = \"$id\" ";
...
<p align=\"center\"><span style=\"font-size:14pt; font-family:Georgia,Verdana;line-height:18pt;\">Consolidados Regionales para el Evento<br />
			  ...
			  <table border=\"0\" cellpadding=\"3\" cellspacing=\"1\" >";
				...
				$sqlCons = "SELECT CONSOLIDAREG_ID, TITULOEVENTO, FECHA, HORA 
								FROM CONSOLIDAREG 
								WHERE EVENTOREGION_ID=\"$id\" ";
...
<form action="../consoliregi/ver/consreg.php" method="post" name="edita" id="edita" target="_blank">
<td align="center">
<input type="hidden" name="id" value="<?php echo $id;?>" />
<input type="hidden" name="consr" value="<?php echo $rsCons->FieldByNumber(0);?>" />
<input type="submit" class="edita" value=" Ver Informe" />
</td>
</form>
