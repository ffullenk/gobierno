...
echo "
			...
			<div id=\"zeroForm\">
			    <H5>Formulario Ingreso Nuevo Evento</H5>
			    <form action=\"graba.php\" method=\"post\" name=\"formulario\" onsubmit=\"return vldEvento();\" >
...
<input type=\"text\" name=\"fecha\" size=\"10\" maxlength=\"10\" value=\"".convertir_fecha($dia)."\" onchange=\"return ValidaFecha2(this.value);\">&nbsp;
						<a href=\"javascript:cal1.popup();\"><img src=\"../../imagenes/panel/cal.gif\" width=\"16\" height=\"16\" border=\"0\" alt=\"Fecha Ocurrencia \"></a>"; ?>
...
<?php echo "			
				...
				<tr>
					<td>(*) T&iacute;tulo:</td>
					<td><input type=\"text\" name=\"titulo\" size=\"50\" maxlength=\"250\" value=\"[".substr(convertir_fecha($dia),0,5)." ". $hora ."] \" /></td>
				</tr>
				
				<tr>
					<td>(*) Resumen:</td>
					<td><textarea name=\"resumen\" rows=\"5\" cols=\"38\"></textarea></td>
				</tr>
				<tr><td colspan=\"2\" height=\"25\"></td></tr>
...
<td colspan=\"2\" align=\"center\"><input type=\"submit\" value=\" Grabar \" class=\"submit\" /></td></tr>
<tr><td colspan=\"2\" height=\"25\"></td></tr>					  
</table>
