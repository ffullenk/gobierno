...
$sqlAdmin = "SELECT NOMBRES, APELLIDOS, EMAIL, CUENTA, CARGO 
				FROM ENCARGADOS AS E, CARGOS AS C
				WHERE E.CARGO_ID=C.CARGO_ID AND 
...
En esta pantalla, usted podr&aacute; visualizar la informaci&oacute;n de su cuenta de usuario registrada en nuestro sistema. Si usted lo desea, puede modificar dicha informaci&oacute;n accediendo al bot&oacute;n <em>Actualizar Datos</em>.<br />
A la izquierda de su pantalla, podr&aacute; visualizar las opciones a las cuales tiene acceso. No olvide <strong>Cerrar Sesi&oacute;n</strong>";?>
<img src="<?php echo _imagenesPanel_; ?>salirsesion.gif" border="0" width="39" height="37" valign="middle" alt=" Salir de la Sesi&oacute;n" />
<?php echo "una vez finalizado de trabajar.<br /><br />

  <div id=\"tablaRegistros\">
    <table cellspacing=\"1\" cellpadding=\"3\" border=\"0\" bgcolor=\"99CC00\">
	  <tr class=\"texto-contenido\"><td bgcolor=\"#EFFFBF\" >Cargo</td><td bgcolor=\"#f5f5f5\" >".$rsAdmin->FieldByNumber(4)."</td></tr>
	  <tr class=\"texto-contenido\"><td bgcolor=\"#EFFFBF\" >Nombre</td><td bgcolor=\"#f5f5f5\">".$rsAdmin->FieldByNumber(0)." ".$rsAdmin->FieldByNumber(1)."</td></tr>
	  <tr class=\"texto-contenido\"><td bgcolor=\"#EFFFBF\" >Email</td><td bgcolor=\"#f5f5f5\">".$rsAdmin->FieldByNumber(2)."</td></tr>
	  <tr class=\"texto-contenido\"><td bgcolor=\"#EFFFBF\" >Nombre de Usuario</td><td bgcolor=\"#f5f5f5\">".$rsAdmin->FieldByNumber(3)."</td></tr>
	</table>
	<form action=\"editar.php\" method=\"post\">
	  <input type=\"submit\" name=\"editar\" class=\"ingresar\" value=\"Actualizar Datos\">
	</form>
  </div>
</div>
";
