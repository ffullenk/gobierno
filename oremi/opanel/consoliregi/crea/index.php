...
<tr><td colspan=\"2\" height=\"25\"></td></tr>
			...
			<tr>
				<th style=\"border-top:3px solid #C0D2DC;font: 11pt bold Verdana;color:#fff; background-color:#285C82;\" colspan=\"2\">
				Consolidados Provinciales Disponibles en Regi&oacute;n de <strong>".$rsEncargado->FieldByNumber(1)."</strong></th>
			</tr>";
...
$sqlConsP = "SELECT CONSOLIDAPROV_ID, TITULOEVENTO, FECHA, HORA, EVENTOPROVINCIA_ID FROM CONSOLIDAPROV AS I, ENCARGADOS AS E, COMUNA AS C WHERE CONSOLIDAREG_ID=\""._sinconsolidaRegion_."\" AND I.ENCARGADO_ID=E.ENCARGADO_ID AND E.COM_ID=C.COM_ID AND C.PROV_ID=\"".$rsProvincias->FieldByNumber(0)."\" ";

//(I.ESTADOEVENTO_ID=\""._eventoCreado_."\" OR I.ESTADOEVENTO_ID=\""._eventoCerrado_."\") AND 
...
<input type=\"radio\" name=\"iaC[".$kontC."]\" value=\"".$rsConsP->FieldByNumber(0)."\" />&nbsp;&nbsp;".$rsConsP->FieldByNumber(1)."&nbsp;<a href=\"../../consoliprov/ver/muestra.php?id=".$rsConsP->FieldByNumber(4)."&consp=".$rsConsP->FieldByNumber(0)."\"  target=\"_blank\" ><img src=\""._imagenesPanel_."veralfa.gif\" border=\"0\" alt=\"Visualizar Informe Alfa \" ></a>
		</td>
	</tr>";
						$kontC++;
