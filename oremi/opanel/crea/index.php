...
<?php echo "			
					  ...
					  <dd><input type=\"text\" name=\"hora\" size=\"5\" maxlength=\"5\" value=\"". $hora . "\" /></dd>
						...
						<fieldset>
						  <legend>Descripci&oacute;n del Evento</legend>
					      <dt>(*) T&iacute;tulo:</dt>
							  <dd><input type=\"text\" name=\"titulo\" size=\"50\" maxlength=\"250\" value=\"".$rsEvento->FieldByNumber(3)."\" /></dd>
					  
					      <dt>(*) Resumen:</dt>
		 					  <dd><textarea name=\"resumen\" rows=\"5\" cols=\"38\">".$rsEvento->FieldByNumber(4)."</textarea>
							  </dd>
						</fieldset>
						<dd>(*) Campos Obligatorios</dd>
