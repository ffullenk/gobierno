...
?>
    <div >
	   ...
	   <?php
		...
		$ssql = "SELECT EVENTOALFA_ID, NRO_EVENTOS, TITULOEVENTO, FECHA_INICIO, HORA_INICIO, ESTADOEVENTO_ID 
	  			FROM EVENTOALFA AS A
...
<p style=\"background-color:#F0E9E1; padding:5px; border:1px solid #fff;font-family:Arial,Verdana; font-size:10pt;\">Usted visualiza en estos momentos, los <strong>Informes Alfas</strong> que ha creado en el tiempo.</p>
