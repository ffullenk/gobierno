...
if(isset($masrec)) {
		...
		$rsDec->FieldByInsert( "INFORMEALFA_ID", "'$alfa'" );
		$rsDec->FieldByInsert( "RECURSO_ID", "'$recurso'" );
		$rsDec->FieldByInsert( "DESCRIPCION", "'$descripcion'" );
		$rsDec->FieldByInsert( "CANTIDAD", "'$cantidad'" );
		$rsDec->FieldByInsert( "GASTO", "'$gasto'" );
		$poneRegistro = $rsDec->execInsert("ALFARECURSOS", 1);
