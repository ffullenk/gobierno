		...
		<div id=\"mconregistro\">
			...
			<div id=\"tablaRegistros\">
			  <table border=\"0\" >";
				...
				$ssql = "SELECT TPEVENTO_ID, TPEVENTO FROM TP_EVENTO";
				if($evento != "") {$ssql .= " WHERE TPEVENTO='".$evento."'"; }
				...
				if( $num_total_registros > 0 ) {
					...
					$rsSQL->Open($ssql);
					echo "<tr><th class=\"tituloTabla\">Tipo de Evento</th><td colspan=\"2\">&nbsp;</tr>";
					$i=0;
...
<?php				} ?>
					<tr> 
						...
						if($pg > 1) {
							echo "<a href='".$_SERVER["PHP_SELF"]."?pg=".($pg-1)."&evento=".$evento."'>";
						...
						if ($total_paginas > 1) {
							for ($i=$minimo; $i<$pg; $i++){
								echo "<a href='".$_SERVER["PHP_SELF"]."?pg=".$i."&evento=".$evento."'> $i</a>&nbsp;";
							}
							echo "[". $pg. "]&nbsp;";
...
echo "
	...
	echo "
			...
			<div id=\"zeroForm\">
			    <H5>Formulario Ingreso Detalle Tipos de Eventos</H5>
