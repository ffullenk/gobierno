...
<?php
  ...
  if($cTPEvento=="") {
      ...
      // Procedemos a Actualizar la informacion
		...
		$rsTPEvento->FieldByUpdate( "TPEVENTO" , "'$cTPEvento'" ); 
		$rsTPEvento->WhereByUpdate( "TPEVENTO_ID" , "$nIdTPEvento" );
		$poneRegistro = $rsTPEvento->execUpdate( "TP_EVENTO" , 1);
