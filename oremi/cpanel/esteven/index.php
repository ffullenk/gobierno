		...
		<div id=\"mconregistro\">
			...
			<div id=\"tablaRegistros\">
			  <table border=\"0\"  >";
				...
				$ssql = "SELECT ESTADOEVENTO_ID, ESTADOEVENTO FROM ESTADOEVENTOS";
				if($evento != "") {$ssql .= " WHERE ESTADOEVENTO='".$evento."'"; }
...
echo "
	...
	echo "
			...
			<div id=\"zeroForm\">
			    <H5>Formulario Ingreso Detalle Estados de los Eventos</H5>
			    <form action=\"graba.php\" method=\"post\" name=\"agrega\">
				  <dl>
				      <dt>Cargo:</dt>
					  <dd><input type=\"text\" name=\"evento\" size=\"30\" maxlenght=\"30\" /></dd>
