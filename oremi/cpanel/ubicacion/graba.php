...
<?php
  ...
  $cUbicacion = $_POST["ubicacion"];
  
  if($cUbicacion=="") {
      echo "
	      <div id=\"errorForm\">
		      <img src=\"../../imagenes/panel/informacion.gif\" /> &nbsp; 
			  No ha ingresado un Detalle para la Ubicación <br />
      ...
      // Procedemos a Grabar la informacion
		...
		$rsTPUbicacion->FieldByInsert( "TPUBICACION", "'$cUbicacion'" );
		$poneRegistro = $rsTPUbicacion->execInsert( "TP_UBICACION" , 1);
