  ...
  if($cAlfa=="") {
      echo "
	      <div id=\"errorForm\">
			  ...
			  No ha ingresado un Detalle para el Estado del Informe Alfa<br />
      ...
      // Procedemos a Actualizar la informacion
		...
		$rsAlfa->FieldByUpdate( "TPALFA" , "'$cAlfa'" ); 
		$rsAlfa->WhereByUpdate( "TPALFA_ID" , "$nIdAlfa" );
		$poneRegistro = $rsAlfa->execUpdate( "TPALFAS" , 1);
