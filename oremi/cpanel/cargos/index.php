		...
		<div id=\"mconregistro\">
			...
			<div id=\"tablaRegistros\">
			  <table border=\"0\" >";
				...
				$ssql = "SELECT CARGO_ID, CARGO FROM CARGOS";
				if($cargo != "") {$ssql .= " WHERE CARGO='".$cargo."'"; }
				...
				if( $num_total_registros > 0 ) {
					...
					$rsSQL->Open($ssql);
					echo "<tr><th class=\"tituloTabla\">Cargo</th><td colspan=\"2\">&nbsp;</tr>";
					$i=0;
...
echo "
	...
	echo "
			...
			<div id=\"zeroForm\">
			    <H5>Formulario Ingreso Detalle Cargos Usuarios del Sistema</H5>
			    <form action=\"graba.php\" method=\"post\" name=\"agrega\">
				  <dl>
				      <dt>Cargo:</dt>
					  <dd><input type=\"text\" name=\"cargo\" size=\"30\" maxlenght=\"30\" /></dd>
