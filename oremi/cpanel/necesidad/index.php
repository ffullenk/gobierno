...
if($loginCorrecto ) { 
	$necesidad = $_GET['necesidad'];

    encOremi();
	izqOremi();
	modOremi("D"); // necesidad
?>
    <div >
       <div >
...
<!-- Central -->
<?php
if(existenRegistros("TPNECESIDAD_ID","TP_NECESIDAD")) {
    // Existen Registros, Muestro Tabla con registros.
    echo "
		<div id=\"mconregistro\">
			
			<form action=\"nuevo.php\" method=\"post\" name=\"nuevo\" >
			  <input type=\"submit\" value=\" Nuevo Tipo de Necesidad \" class=\"crea\" align=\"right\" />
			</form>
			...
			<div id=\"tablaRegistros\">
			  <table border=\"0\" >";
				...
				$ssql = "SELECT TPNECESIDAD_ID, TPNECESIDAD FROM TP_NECESIDAD";
				...
				if( $num_total_registros > 0 ) {
					...
					$rsSQL->Open($ssql);
					echo "<tr><th class=\"tituloTabla\">Tipo de Necesidad</th><td colspan=\"2\">&nbsp;</tr>";
					$i=0;
...
echo "
	...
	echo "
			...
			<div id=\"zeroForm\">
			    <H5>Formulario Ingreso Detalle Tipos de Necesidades</H5>
