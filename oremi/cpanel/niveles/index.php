		...
		<div id=\"mconregistro\">
			...
			<div id=\"tablaRegistros\">
			  <table border=\"0\" class=\"tablaAdmin\" >";
				...
				$ssql = "SELECT TPCAPRESPUESTA_ID, TPCAPRESPUESTA FROM TP_CAPRESPUESTA";
				if($nivel != "") {$ssql .= " WHERE TPCAPRESPUESTA='".$nivel."'"; }
				...
				if( $num_total_registros > 0 ) {
					...
					$rsSQL->Open($ssql);
					echo "<tr><th class=\"tituloTabla\">Capacidad de Respuesta</th><td colspan=\"2\">&nbsp;</tr>";
					$i=0;
...
echo "
	...
	echo "
			...
			<div id=\"zeroForm\">
			    <H5>Formulario Ingreso Detalle Niveles de Capacidad de Respuesta</H5>
