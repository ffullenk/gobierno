                              ...
                              <tr>
                                 <td> 
                                    <?
                                        ...
                                        echo('<form action="consolidaReg.php" name="form" method="post">'); //
                                    ...
                                    ?>
                                         <table border=0 cellspacing=1 cellpadding=0 width=100% bgcolor=#F0F6F9>
                                            ...
                                            <!-- Conocer los Informes de Consolidados Provinciales de Tabla InfConsProvincia
                                                 [del id de la fuente actual] 
					                    		   SELECT InfConsProv.idinfconsprov, InfConsProvincia.idconsprov, 
							                              InfConsProv.idcons, InfConsProvincia.idfuente, 
                								    	  InfConsProvincia.idestadoevento, InfConsProvincia.descinforme 
                     							     FROM InfConsProv 
	                           							 INNER JOIN InfConsProvincia ON 
		                        						            InfConsProv.idconsprov = InfConsProvincia.idconsprov 
								                    			WHERE InfConsProvincia.idfuente = '$fuenteprovincia' 
                 											      AND InfConsProvincia.idestadoevento = '2'
                                            -->
<?
                                            $cons_prov = mysql_query("SELECT InfConsProv.idinfconsprov, InfConsProvincia.idconsprov, InfConsProv.idcons, InfConsProvincia.idfuente, InfConsProvincia.idestadoevento, InfConsProvincia.descinforme FROM InfConsProv INNER JOIN InfConsProvincia ON InfConsProv.idconsprov = InfConsProvincia.idconsprov WHERE InfConsProvincia.idfuente = '$fuenteprovincia' AND InfConsProvincia.idestadoevento = '1' AND InfConsProvincia.idinfconsreg = '0' ") or die(mysql_error());
...
?>
          ...
          <td width="125" valign="top"> <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablebody">
              <tr> 
                <td width="126" height="150" valign="top"> <table width="95%" border="0" align="center" cellpadding="0" cellspacing="1" class="tableborderAlerta">
                    <tr> 
