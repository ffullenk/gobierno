...
if ($HTTP_GET_VARS['accion'] == "fuente") {
      ...
      $con_fuente = mysql_query("SELECT *  FROM FUENTE") or Die("Imposible Realizar Consulta a Tabla Fuente en estos Momentos ... Ha ocurrido un error inesperado.. !!! ");
      ...
      cabeceraFuenteHTML();
       ...
       echo "<tr><td ColSpan=2 height=25></td></tr>";
       echo "<tr><td ColSpan=2>";
//       if (mysql_num_rows($con_fuente) > 0 ) {
           echo('<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablebodytext" bgcolor="#FFFFFF">');
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td ColSpan=3>');
          echo('            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablebodytext" bgcolor="#FFFFFF">');
          echo('              <tr bgcolor=#dde5f2>');
          echo('                <td>Origen Fuente</td><td width=1 bgcolor=#ffffff></td><td >Regional</td><td width=1 bgcolor=#ffffff></td><td >Provincial</td><td width=1 bgcolor=#ffffff></td><td >Comunal</td>');
          echo('               </tr>');
          echo('               <tr bgcolor=#ffffff>');
          echo('                 <td ColSpan=7></td>');
          echo('               </tr>');
          echo('               <tr bgcolor=#dde5f2>');
          echo('                <td>Origen Fuente</td><td width=1 bgcolor=#ffffff></td><td ColSpan=5></td>');
          echo('               </tr>'); 
          echo('            </table>');
          echo('        </td>');
          echo('  </tr>');  
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Nombre</td><td width=1 bgcolor=#ffffff></td><td >Regional</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>UserName</td><td width=1 bgcolor=#ffffff></td><td >UserNamel</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Password</td><td width=1 bgcolor=#ffffff></td><td >Password</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Nivel</td><td width=1 bgcolor=#ffffff></td><td >Nivel</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Cargo</td><td width=1 bgcolor=#ffffff></td><td >Cargo</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Fono</td><td width=1 bgcolor=#ffffff></td><td >Fonol</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Celular</td><td width=1 bgcolor=#ffffff></td><td >Celular</td>');
          echo('  </tr>');
          ...
          echo('  <tr bgcolor=#dde5f2>');
          echo('        <td>Email</td><td width=1 bgcolor=#ffffff></td><td >Email</td>');
          echo('  </tr>');
  ...
  // Agregar Nueva Fuente a Tabla FUENTE
    ...
    // Chequear Variables
       ...
       // Chequear en Tabla FUENTE, existencia de dato a ingresar
        $con_fuente = mysql_query("SELECT idfuente FROM FUENTE WHERE idfuente='$fuenteId'") Or DIE("Imposible Relizar Consulta en Tabla FUENTE en este Momento ... Intente Nuevamente");
           ...
           if ($row=mysql_num_rows($con_fuente) > 0) {
            ...
            //Agregar a Tabla FUENTE
              $passw = md5($passw);
              mysql_query("INSERT INTO FUENTE(idfuente,tipofuente,nombre,username,password,nivel,cargo,fono,celular,email) VALUES('$fuenteId','$tipo','$nombre','$uname','$passw','$nivel','$cargo','$fono','$celular','$email')") or DIE("Imposible Guardar Registro en Tabla FUENTE .. Ha Surgido un Problema Inesperado..!!");
