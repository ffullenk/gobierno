    ...
    // Mostrar Informacion de la Tabla Consolidado Regional que viene de antes
       ...
       if( $row=mysql_fetch_object( $con_ninf ) ) {
         ...
         // En este punto debiese grabar info en tabla tblconsreg
            ...
            // Para despues de despachar el consolidado, necesitaré actualizar tabla tblconsreg
       ...
       // Es tiempo de Consolidar Regionalmente :o)
          ...
          while($rADec = mysql_fetch_object($con_Dec)) {
                mysql_query("INSERT INTO ConsRegDecisiones(idconsreg_, idprov, accion, tiemporestablece) VALUES('$idtblconsreg','$v','$rADec->accion','$rADec->tiemporestablece')") or Die("Error ... Imposible Añadir Registro en Tabla Consolidado Decisiones.");
          }
          ...
          while($rANec = mysql_fetch_object($con_Nec)) {
                mysql_query("INSERT INTO ConsRegNecesidades(idconsreg_, idprov, cantidad, tipo, motivo) VALUES('$idtblconsreg','$v','$rANec->cantidad','$rANec->tipo','$rANec->motivo')") or Die("Error ... Imposible Añadir Registro en Tabla Consolidado Necesidades.");
          }
          ...
          while($rARec = mysql_fetch_object($con_Rec)) {
                mysql_query("INSERT INTO ConsRegRecursos(idconsreg_, idprov, idtiporecurso, descrirecurso, cantidadrecur, gastoestimado) VALUES('$idtblconsreg','$v','$rARec->idtiporecurso','$rARec->descrirecurso','$rARec->cantidadrecur','$rARec->gastoestimado')") or die("Error ... Imposible Añadir Registro en Tabla Consolidado Recursos.");
          }
