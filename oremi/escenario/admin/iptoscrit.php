 ...
 if(estaActivo($userBackEnd, $passBackEnd)) {
   ...
   <td>
      <table border="0" width="90%" cellspacing="0" cellpadding="0" style="margin:20px auto; padding:0;" >
        <tr>
           <td align="right"><a href="form_agrega_ptoscrit.php">Agregar Punto Critico</a></td>
        </tr>
...
$sqlVal = "SELECT ID_PTOCRITICO, PTOCRITICO, SERVREL, ESTADOPTOCRITICO FROM orm_ptoscriticos";
...
if( $num_total_registros > 0 ) {
   ...
   while($puntero = mysql_fetch_array($rsTabla) ) {
	 ...
	 <td align=\"center\">";
         ...
         echo "</td>
         <td align=\"center\">
            <a href=\"form_actualiza_ptoscrit.php?idP=".$puntero['ID_PTOCRITICO']."\" title=\"Actualizar Datos\">
