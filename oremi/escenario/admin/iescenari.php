 ...
 if(estaActivo($userBackEnd, $passBackEnd)) {
   ...
   <td>
      <table border="0" width="90%" cellspacing="0" cellpadding="0" style="margin:20px auto; padding:0;" >
        <tr>
           <td align="right"><a href="form_agrega_escenari.php">Agregar Escenario</a></td>
        </tr>
...
$sqlVal = "SELECT ID_ESCENARIO, DESCRIBEESCENARIO, OCURRENCIA, HORA, ESTADOESCENARIO FROM orm_escenario";
...
if( $num_total_registros > 0 ) {
   ...
   while($puntero = mysql_fetch_array($rsTabla) ) {
      ...
      echo "
      <tr Bgcolor=\"".$color."\">
         <td>".$puntero['OCURRENCIA']."/".$puntero['HORA']." ".$puntero['DESCRIBEESCENARIO']."</td>
	 <td align=\"center\">";
            if($puntero['ESTADOESCENARIO']=="A") { 
         ...
         echo "</td>
         <td align=\"center\">
            <a href=\"form_actualiza_escenari.php?idE=".$puntero['ID_ESCENARIO']."\" title=\"Actualizar Datos\">
