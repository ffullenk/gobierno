 ...
 if(estaActivo($userBackEnd, $passBackEnd)) {
   ...
   <td>
      <table border="0" width="90%" cellspacing="0" cellpadding="0" style="margin:20px auto; padding:0;" >
        <tr>
           <td align="right"><a href="form_agrega_instituc.php">Agregar Instituci&oacute;n</a></td>
        </tr>
...
$sqlVal = "SELECT ID_INSTITUCION, INSTITUCION, ESTADOINST FROM orm_institucion";
...
if( $num_total_registros > 0 ) {
   ...
   while($puntero = mysql_fetch_array($rsTabla) ) {
      ...
      echo "
      <tr Bgcolor=\"".$color."\">
         <td>".$puntero['INSTITUCION']."</td>

	 <td align=\"center\">";
            if($puntero['ESTADOINST']=="A") { 
         ...
         echo "</td>
         <td align=\"center\">
            <a href=\"form_actualiza_instituc.php?idI=".$puntero['ID_INSTITUCION']."\" title=\"Actualizar Datos\">
