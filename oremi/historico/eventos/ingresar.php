...
?>
	<div id="colTwo">
		<div class="bg2">
			<h2><em>Eventos</em>: Agregar Evento</h2>
			<p></p> <!-- Agregar Evento. -->
		    <h3>Formulario Agregar Evento</h3>
		    <div class="bg1">
			    <p align="right"><a href="ingresar.php" title="Agregar Evento">Agregar Evento</a></p>
				...
				<form action="procesar.php" method="post" name="evento" id="evento" onSubmit="chequea_form_evento(); return false">
				<table border="0" cellspacing="2" cellpadding="3" width="90%" align="center" id="listaTabla">
                   <tr><th colspan="2" style="font-size:1.8em;">Formulario Crear Evento</th></tr>
...
//-->
				   ...
				   <tr><td colspan="2" >
					...
					<tr><td colspan="2">
					        <textarea name="evento_observaciones" id="evento_observaciones" rows="7" cols="60"></textarea>
					    </td>
					</tr>
