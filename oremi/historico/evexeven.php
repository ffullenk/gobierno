          ...
          <tr>
             ...
             <table border=\"0\" cellspacing=\"5\" cellpadding=\"5\" align=\"center\" id=\"menutabla\">
                <tr>
                   ...
                   <td><a href=\"evexcomu.php\">x Comuna</a></td>
                   <td class=\"actual\"><a href=\"evexeven.php\">x Evento</a></td>
                </tr>
             </table>
             </td>
          ...
          <tr>
             ...
             <td>
                ...
                <select name=\"q\" size=\"1\">";
                 ...
                 $qEvento = "SELECT tpevento_id, tpevento FROM orm_tipoevento WHERE estado=\"A\"";
                               $rEvento = mysql_query($qEvento);
                               if(mysql_num_rows($rEvento) > 0 )
                               {
                                  echo "<option value=\"-\">Todos los Eventos</option>";
                                  while($pEve = mysql_fetch_array($rEvento))
                                  {
                                    if($pEve['tpevento_id']==$q)
                                    {
                                       echo "<option value=\"".$pEve['tpevento_id']."\" selected>".htmlentities($pEve['tpevento'])."</option>";
                                    } else {
                                       echo "<option value=\"".$pEve['tpevento_id']."\">".htmlentities($pEve['tpevento'])."</option>";
                                    }
                                  }
                               }
...
echo "           </select>
 ...
 if($q!="-") { $qEventos.= " AND H.tpevento_id='".$q."'"; }
 
 $qEventos.= " ORDER BY DATE_FORMAT(fechaevento,'%d-%m-%Y') ASC "; 
            ...
            <table border=\"0\" cellspacing=\"2\" cellpadding=\"7\" width=\"95%\" align=\"center\" style=\"border:1px solid #ccc;\">
                    ...
                    while($puntero = mysql_fetch_array($rEventos) ) {
                        ...
                        <tr Bgcolor=\"".$color."\">
                            ...
                            <td><a href=\"ve_localidades.php?id=".$puntero['evento_id']."\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=460,height=400,scrollbars=yes'); return false;\">Ver Localidades</a> | <a href=\"ve_evento.php?id=".$puntero['evento_id']."&o=4\">Ver Detalle</a></td>                            
                        </tr>";
                    } //desconectar($link);
