...
?>
	...
	<div id="colTwo">
		<div class="bg2">
			<h2><em>Consultas</em>: Eventos Hist&oacute;ricos por Tipo de Evento</h2>
			<p>Lista los Eventos Hist&oacute;ricos por Tipo de Evento.</p>
		
		    <h3>Listado de Eventos Hist&oacute;ricos por Tipo de Evento</h3>
		    <div class="bg1">
					  ...
					  <td>
					     ...
					     <select name="q" size="1">
						    <?php
							   ...
							   {
							      echo "<option value=\"-\">Seleccione Tipo de Evento...</option>";
