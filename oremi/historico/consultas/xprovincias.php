...
?>
	...
	<div id="colTwo">
		<div class="bg2">
			<h2><em>Consultas</em>: Eventos Hist&oacute;ricos por Provincias</h2>
			<p>Lista los Eventos Hist&oacute;ricos por Provincias.</p>
		
		    <h3>Listado de Eventos Hist&oacute;ricos por Provincias</h3>
		    <div class="bg1">
