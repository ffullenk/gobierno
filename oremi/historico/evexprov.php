          ...
          <tr>
             ...
             <table border=\"0\" cellspacing=\"5\" cellpadding=\"5\" align=\"center\" id=\"menutabla\">
                <tr>
                   ...
                   <td class=\"actual\"><a href=\"evexprov.php\">x Provincia</a></td>
          ...
          <tr>
             ...
             <td>
                ...
                <select name=\"q\" size=\"1\">";
                  ...
                  $qProv = "SELECT PROV_ID, PROVINCIA FROM PROVINCIA WHERE REGION_ID=\"4\"";
                  $rProv = mysql_query($qProv);
                  if(mysql_num_rows($rProv) > 0 )
                  {
                     echo "<option value=\"-\">Todas las Provincias</option>";
                     while($pProv = mysql_fetch_array($rProv))
                        {
                           if($pProv['PROV_ID']==$q)
                           {
                              echo "<option value=\"".$pProv['PROV_ID']."\" selected>".htmlentities($pProv['PROVINCIA'])."</option>";
                           } else {
                              echo "<option value=\"".$pProv['PROV_ID']."\">".htmlentities($pProv['PROVINCIA'])."</option>";
                           }
                         }
                   }
            ...
            <table border=\"0\" cellspacing=\"2\" cellpadding=\"7\" width=\"95%\" align=\"center\" style=\"border:1px solid #ccc;\">
                    ...
                    while($puntero = mysql_fetch_array($rEventos) ) {
                        ...
                        <tr Bgcolor=\"".$color."\">
                            ...
                            <td><a href=\"ve_localidades.php?id=".$puntero['evento_id']."\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=460,height=400,scrollbars=yes'); return false;\">Ver Localidades</a> | <a href=\"ve_evento.php?id=".$puntero['evento_id']."&o=2\">Ver Detalle</a></td>                            
                        </tr>";
                    } //desconectar($link);
