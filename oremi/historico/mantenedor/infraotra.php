...
?>
	<div id="colTwo">
		<div class="bg2">
		    ...
		    <h3>Listado de Registros Otra Infraestructura</h3>
		    <div class="bg1">
				...
				echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" width=\"90%\" align=\"center\" id=\"listaTabla\">
				        <tr><th>Nombre Registro Otra Infraestructura</th><th colspan=\"2\">Estado</th></tr>";
                 /* Limito la busqueda */
                 ...
                 $sqlVal = "SELECT otrainfra_id, otrainfra, estado FROM orm_otrainfra";
                 ...
                 if( $num_total_registros > 0 ) {
                    ...
                    while($puntero = mysql_fetch_array($rsTabla) ) {
                      ...
                      echo "</td>
                            <td align=\"center\"><a href=\"form_modificar_infraotra.php?id=".$puntero['otrainfra_id']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/></a></td>
                        </tr>";
                    } //desconectar($link);
