		...
		<div class="bg2">
		    ...
		    <div class="bg1">
				...
				echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" width=\"90%\" align=\"center\" id=\"listaTabla\">
				        <tr><th>Nombre Vialidad</th><th colspan=\"2\">Estado</th></tr>";
                 /* Limito la busqueda */
                 ...
                 $sqlVal = "SELECT vialidad_id, vialidad, estado FROM orm_vialidad";
                 ...
                 if( $num_total_registros > 0 ) {
                    ...
                    while($puntero = mysql_fetch_array($rsTabla) ) {
                      ...
                      echo "</td>
                            <td align=\"center\"><a href=\"form_modificar_vialidad.php?id=".$puntero['vialidad_id']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/></a></td>
                        </tr>";
                    } //desconectar($link);
