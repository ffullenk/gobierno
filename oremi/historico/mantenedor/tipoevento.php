...
?>
	<div id="colTwo">
		<div class="bg2">
		    ...
		    <h3>Listado de Registros Tipos de Evento</h3>
		    <div class="bg1">
			    <p align="right"><a href="form_agregar_tipoevento.php" title="Agregar Registro de Tipos de Evento">Agregar Registro de Tipos de Evento</a></p>
				<?php
				echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" width=\"90%\" align=\"center\" id=\"listaTabla\">
				        <tr><th>Tipo de Evento</th><th colspan=\"2\">Estado</th></tr>";
                 /* Limito la busqueda */
                 ...
                 $sqlVal = "SELECT tpevento_id, tpevento, estado FROM orm_tipoevento";
                 ...
                 if( $num_total_registros > 0 ) {
                    ...
                    while($puntero = mysql_fetch_array($rsTabla) ) {
                      ...
                      echo "</td>
                            <td align=\"center\"><a href=\"form_modificar_tipoevento.php?id=".$puntero['tpevento_id']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/></a></td>
                        </tr>";
                    } //desconectar($link);
