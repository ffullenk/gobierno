            ...
            <table border=\"0\" cellspacing=\"2\" cellpadding=\"7\" width=\"95%\" align=\"center\" style=\"border:1px solid #ccc;\">
                    ...
                    while($puntero = mysql_fetch_array($rEventos) ) {
                        ...
                        <tr Bgcolor=\"".$color."\">
                            ...
                            <td><a href=\"ve_localidades.php?id=".$puntero['evento_id']."\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=460,height=400,scrollbars=yes'); return false;\">Ver Localidades</a> | <a href=\"ve_evento.php?id=".$puntero['evento_id']."&o=3\">Ver Detalle</a></td>                            
                        </tr>";
                    } //desconectar($link);
