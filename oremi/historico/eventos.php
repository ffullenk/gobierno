<?php
       ...
       <table border=\"0\" cellspacing=\"0\"  cellpadding=\"0\" width=\"100%\">
          ...
          <tr>
             ...
             <table border=\"0\" cellspacing=\"5\" cellpadding=\"5\" align=\"center\" id=\"menutabla\">
                <tr>
                   <td class=\"actual\"><a href=\"\" >Todos</a></td>
 ...
 $qEventos = "SELECT evento_id, tpevento, COMUNA, DATE_FORMAT(fechaevento,'%d-%m-%Y') AS fecha, evento_obs ".
            ...
            <table border=\"0\" cellspacing=\"2\" cellpadding=\"7\" width=\"95%\" align=\"center\" style=\"border:1px solid #ccc;\">
                    ...
                    while($puntero = mysql_fetch_array($rEventos) ) {
                        ...
                        <tr Bgcolor=\"".$color."\">
                            ...
                            <td><a href=\"ve_localidades.php?id=".$puntero['evento_id']."\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=460,height=400,scrollbars=yes'); return false;\">Ver Localidades</a> | <a href=\"ve_evento.php?id=".$puntero['evento_id']."&o=1\">Ver Detalle</a></td>                            
                        </tr>";
                    } //desconectar($link);
