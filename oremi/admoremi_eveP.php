...
//                echo "Fecha_act: $fecha_act <BR>";

           // Grabar Registro en Tabla Consolidado Provincia
              mysql_query("INSERT INTO ConsolidaProvincia(idtipoevento, idfuente, descinforme, ocurrencia, nrocons, idestadoevento, idubicacion, resumen) VALUES($tipoevento,'$idlfuente','$describeevento','$fecha_act',0,0,$ubicacion,'$resumenevento')") or die(mysql_error());

// -----------------------------------------------------------------------
// En Realidad, Solo Serviría Añadir Registro en Tabla InfConsProv sólo
// cuando se ha consolidado un informe alfa para la provincia.
// No es relevante crear un registro cuando se crea el evento consolidado
// provincial.
//              $cons_lastsave = mysql_query("SELECT idconsprov, idfuente, ocurrencia FROM ConsolidaProvincia WHERE idfuente = '$idlfuente' AND ocurrencia = '$fecha_act'") or die(mysql_error());
...
//                 $idconsolidado = $row[idconsprov];
//              } else { echo "Ha Ocurrido un Error inesperado ... Por favor, reintente nuevamente la &uacute;ltima operaci&oacute;n o p&oacute;ngase en contacto con el administrador del sitio."; }
//              mysql_free_result($cons_lastsave);
//
//              // Grabo info en Tabla de Informes Consolidados Provinciales
//              //   mysql_query("INSERT INTO InfConsProv(idconsprov, idcons) VALUES('$idconsolidado',0)") or die(mysql_error());
//
              mysql_close();  
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablebody">
                      ...
                      <tr bgcolor="#F7F7F7"> 
                        <td height="80" colspan="3" valign="middle" align="center"> 
                          <textarea name="describeevento" rows="5" cols="55"></textarea> 
                          &nbsp;</td>
                      </tr>
                      <tr> 
                        <td height="10" colspan="3" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>
