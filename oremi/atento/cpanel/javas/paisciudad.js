...
pc_listadoSelects[0]="regiones";
pc_listadoSelects[1]="provincias";
pc_listadoSelects[2]="comunas";
...
function pc_cargaContenido(idSelectOrigen)
{
    ...
    else if(idSelectOrigen!=pc_listadoSelects[pc_listadoSelects.length-1])
    {
        ...
        ajax.open("GET", "paisciudad.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada+"&sid="+Math.random(), true);
