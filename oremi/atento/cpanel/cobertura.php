			 ...
			 <tr>
			    <td align="center">
				    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
		              <tr><td  align="right"><a href="cobertura_form.php">[+] Agregar Cobertura</a></td></tr>
		              <tr>
		                 <td align="center">
			             <?php
			               echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" align=\"center\" style=\"margin:0 auto;\">
			                       <tr><th>Nombre Cobertura</th><th colspan=\"2\"></th></tr>";
                                   /* Limito la busqueda */
                                   ...
                                   $sqlVal = "SELECT IDCOBERTURA, COBERTURA, ESTADOCOBERTURA FROM tb_cobertura";
                                   ...
                                   if( $num_total_registros > 0 ) {
					                 ...
					                 while($puntero=mysql_fetch_array($rsTabla))
					                 {
                                        ...
                                        echo "
                                        <tr Bgcolor=\"".$color."\">
                                           <td>".$puntero['COBERTURA']."</td>
                                           <td align=\"center\"><a href=\"cobertura_modifica.php?id=".$puntero['IDCOBERTURA']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/>Modificar</a></td>
							               <td align=\"center\">";
                                               if($puntero['ESTADOCOBERTURA']=="A") { echo "<img src=\""._rutaImagenes_."green.png\" width=\"16\" alt=\"Activado\" height=\"16\" border=\"0\" />"; } 
