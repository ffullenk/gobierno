			 ...
			 <tr>
			    <td align="center">
				    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
		              <tr><td  align="right"><a href="organizador_form.php">[+] Agregar Organizador</a></td></tr>
		              <tr>
		                 <td align="center">
			             <?php
			               echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" align=\"center\" style=\"margin:0 auto;\">
			                       <tr><th>Nombre Organizador</th><th colspan=\"2\"></th></tr>";
                                   /* Limito la busqueda */
                                   ...
                                   $sqlVal = "SELECT IDORGANIZADOR, ORGANIZADOR, ESTADOORGANIZADOR FROM tb_organizador";
                                   ...
                                   if( $num_total_registros > 0 ) {
					                 ...
					                 while($puntero=mysql_fetch_array($rsTabla))
					                 {
                                        ...
                                        echo "
                                        <tr Bgcolor=\"".$color."\">
                                           <td>".$puntero['ORGANIZADOR']."</td>
                                           <td align=\"center\"><a href=\"organizador_modifica.php?id=".$puntero['IDORGANIZADOR']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/>Modificar</a></td>
							               <td align=\"center\">";
                                               if($puntero['ESTADOORGANIZADOR']=="A") { echo "<img src=\""._rutaImagenes_."green.png\" width=\"16\" alt=\"Activado\" height=\"16\" border=\"0\" />"; } 
