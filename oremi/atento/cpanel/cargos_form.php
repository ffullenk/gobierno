		   ...
		   <table width="" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" >
			 ...
			 <tr>
			    <td>
                  ...
                  <form action="cargos_grabar.php" method="post" name="cargos" id="cargos" onSubmit="chequea_form_cargos(); return false">

				  <table width="" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff">
				      <tr><th colspan="2"> FORMULARIO CREACION CARGOS</th></tr>
					  <tr>
					     <td>Asignaci&oacute;n de Cargo:</td>
					     <td><input type="text" name="cargo" id="cargo" size="50" maxlength="50" /></td>
					  </tr>
					  <tr>
					  ...
					  <tr><td colspan="2"><input type="submit" name="creacargo" value=" CREAR CARGO   " /></td></tr>
				   </table>
				   </form>
				</td>
			 </tr>
