			 ...
			 <tr>
			    <td align="center">
				    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
		              <tr><td  align="right"><a href="colaboradores_form.php">[+] Agregar Colaborador</a></td></tr>
		              <tr>
		                 <td align="center">
			             <?php
			               echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" align=\"center\" style=\"margin:0 auto;\">
			                       <tr><th>Nombre Colaborador</th><th>Cargo</th><th colspan=\"2\"></th></tr>";
                                   /* Limito la busqueda */
                                   ...
                                   $sqlVal = "SELECT IDCOLABORADOR, COLABORADOR, IDCARGO, ESTADOCOLABORADOR FROM tb_colaboradores";
                                   ...
                                   if( $num_total_registros > 0 ) {
					                 ...
					                 while($puntero=mysql_fetch_array($rsTabla))
					                 {
                                        ...
                                        echo "
                                        <tr Bgcolor=\"".$color."\">
                                           <td>".$puntero['COLABORADOR']."</td>
										   <td>".TipoCargo($puntero['IDCARGO'])."</td>
                                           <td align=\"center\"><a href=\"colaboradores_modifica.php?id=".$puntero['IDCOLABORADOR']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/>Modificar</a></td>
							               <td align=\"center\">";
                                               if($puntero['ESTADOCARGO']=="A") { echo "<img src=\""._rutaImagenes_."green.png\" width=\"16\" alt=\"Activado\" height=\"16\" border=\"0\" />"; } 
