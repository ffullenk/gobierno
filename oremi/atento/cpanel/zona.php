			 ...
			 <tr>
			    <td align="center">
				    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
		              <tr><td  align="right"><a href="zona_form.php">[+] Agregar Zona</a></td></tr>
		              <tr>
		                 <td align="center">
			             <?php
			               echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" align=\"center\" style=\"margin:0 auto;\">
			                       <tr><th>Nombre Ejercicio</th><th>Nombre Zona</th><th>Encargado</th><th colspan=\"2\"></th></tr>";
                                   /* Limito la busqueda */
                                   ...
                                   $sqlVal = "SELECT IDZONAEJERCICIO,IDREGION,IDPROVINCIA,IDCOMUNA,NOMBREZONA, FECHACREACION, IDENCARGADO, IDEJERCICIO, IDCOLABORADOR,ESTADOZONA FROM tb_zonaejercicio WHERE ESTADOZONA=\"A\"";
                                   ...
                                   if( $num_total_registros > 0 ) {
					                 ...
					                 while($puntero=mysql_fetch_array($rsTabla))
					                 {
                                        ...
                                        <tr Bgcolor=\"".$color."\">
										   ...
										   <td>".NombreEncargado($puntero['IDENCARGADO'])."</td>
										   <td align=\"center\"><a href=\"zona_modifica.php?id=".$puntero['IDZONAEJERCICIO']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/>Modificar</a></td>
							               <td align=\"center\">";
                                               if($puntero['ESTADOZONA']=="A") { echo "<img src=\""._rutaImagenes_."green.png\" width=\"16\" alt=\"Activado\" height=\"16\" border=\"0\" />"; } 
