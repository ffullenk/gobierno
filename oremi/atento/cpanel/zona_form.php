		   ...
		   <table width="" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" >
			 ...
			 <tr>
			    <td>
				  ...
				  <form action="zona_grabar.php" method="post" name="zona" id="zona" enctype="multipart/form-data" onSubmit="chequea_form_zona(); return false">

				  <table width="" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff">
				      <tr><th colspan="2"> FORMULARIO CREACION ZONAS</th></tr>
					  <tr>
					     <td>Asignaci&oacute;n de Nombre de Zona:</td>
					     <td><input type="text" name="zona_nombre" id="zona_nombre" size="50" maxlength="50" /></td>
					  </tr>
					  <tr>
