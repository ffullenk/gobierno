			 ...
			 <tr>
			    <td align="center">
				    <table width="450" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#ffffff" style="margin:0 auto;">
		              <tr><td  align="right"><a href="ejercicio_form.php">[+] Agregar Ejercicio</a></td></tr>
		              <tr>
		                 <td align="center">
			             <?php
			               echo "<table border=\"0\" cellspacing=\"2\" cellpadding=\"3\" align=\"center\" style=\"margin:0 auto;\">
			                       <tr><th>Nombre Ejercicio</th><th>Cobertura</th><th>Organizador</th><th>Fecha Realizaci&oacute;n</th><th colspan=\"2\"></th></tr>";
                                   /* Limito la busqueda */
                                   ...
                                   $sqlVal = "SELECT IDEJERCICIO,NOMBREEJERCICIO,FECHAEJERCICIO,IDCOBERTURA,IDORGANIZADOR, ESTADOEJERCICIO FROM tb_ejercicios";
                                   ...
                                   if( $num_total_registros > 0 ) {
					                 ...
					                 while($puntero=mysql_fetch_array($rsTabla))
					                 {
                                        ...
                                        echo "
                                        <tr Bgcolor=\"".$color."\">
                                           <td>".$puntero['NOMBREEJERCICIO']."</td>
										   <td>".TipoCobertura($puntero['IDCOBERTURA'])."</td>
										   <td>".TipoOrganizador($puntero['IDORGANIZADOR'])."</td>
										   <td>".$puntero['FECHAEJERCICIO']."</td>
                                           <td align=\"center\"><a href=\"ejercicio_modifica.php?id=".$puntero['IDEJERCICIO']."\" title=\"Actualizar Datos\"><img src=\""._rutaImagenes_."actualizar.png\" border=\"0\" width=\"16\" height=\"16\"/>Modificar</a></td>
							               <td align=\"center\">";
                                               if($puntero['ESTADOEJERCICIO']=="A") { echo "<img src=\""._rutaImagenes_."green.png\" width=\"16\" alt=\"Activado\" height=\"16\" border=\"0\" />"; } 
