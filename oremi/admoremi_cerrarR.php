           ...
           <td width="455" height="21" valign="top">
		     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tablebody">
               <tr> 
                  ...
                  <? if( $Nniv == "1") { $msg01 = "Eventos Regionales por Cerrar"; }
                         echo " $msg01 "; ?>
                  </td>
               </tr>
               <tr> 
...
<?                                 while($row=mysql_fetch_object($con_ninf)) {
                                     ...
                                     <tr bgcolor="#FfFfFf">
                                       ...
                                       <td width="63%" bgcolor="#FFFFFF"><a href="<? $PHP_SELF?>?acc=mcons&id=<?php echo $row->idconsreg; ?>&userN=<?php echo $userN; ?>" class="enlace"><?php echo $fecha; ?></a></td>
                                       <td width="10%" bgcolor="#F0F6F9">&nbsp;NºInf.</td>
                                       <td width="17%" align="left" bgcolor="#FFFFFF"><a href="<? $PHP_SELF?>?acc=mcons&id=<?php echo $row->idconsreg; ?>&userN=<?php echo $userN; ?>" class="enlace"><?php echo $row->nrocons; ?></a></td>
                                     </tr>
                                     <tr bgcolor="#FFFFFF">
                                       <td colspan="2" bgcolor="#FFFFFF"> <a href="<? $PHP_SELF?>?acc=mcons&id=<?php echo $row->idconsreg; ?>&userN=<?php echo $userN; ?>" class="enlace"><?php echo $describe; ?></a></td>
                                       <td colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"><strong><a href="<? $PHP_SELF?>?acc=cr&id=<? echo $row->idconsreg;?>" class="blueunder">&raquo; Cerrar Evento &laquo;</a></strong></td>
                                     </tr>
...
<?                       if ( $xst == 1 ) { 
                            echo "<strong>No Existen Eventos Regionales por Cerrar</strong>";
						 } ?>
                    </td>
               </tr>
...
if( $HTTP_GET_VARS[acc] == "cr" ) {
    mysql_query( "UPDATE ConsolidaRegion SET idestadoevento = '3' WHERE idconsreg = '$id' " ) or die( mysql_error() );
    header("Location: admoremi_viewconsR.php?userN=$userN" );
}
