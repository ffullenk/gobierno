...
echo "<table width=200 cellspacing=1 cellpadding=1 border=0 bgcolor=#9eb5da><tr><td colspan=7 align=center class=tit>";
echo "<table width=100% cellspacing=2 cellpadding=2 border=0 ><tr><td style=font-size:9pt;font-weight:bold;color:white>";
...
echo "<a style='color:#7cb6de;text-decoration:none' href=index.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
// echo "href=index.php?$parametros_formulario&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior";
...
echo "<a style=color:#7cb6de;text-decoration:none href=index.php?$parametros_formulario&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente>&gt;&gt;</a></td></tr></table></td></tr>";
echo '	<tr>
...
//echo "ultimo dia del mes: $ultimo_dia<BR>";
...
for ($i=0;$i<7;$i++){
 if ($i < $numero_dia){
   //si el dia de la semana i es menor que el numero del primer dia de la semana no pongo nada en la celda
     ...
     echo "<td bgcolor=#ffffff align=center><a href='javascript:devuelveFecha($dia_actual,$mes,$ano)'". dame_estilo($dia_actual) .">$dia_actual</a></td>";
$dia_actual++;
 }
}
echo "</tr>";
...
// //////////////////////////////////////////////////////////////////////////////////////////////////////////
// Función que escribe en la página un fomrulario preparado para introducir una fecha y enlazado con el
// calendario para seleccionarla comodamente
// //////////////////////////////////////////////////////////////////////////////////////////////////////////
