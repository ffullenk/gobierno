...
//
// La página que llame a esta libreria debe contener un formulario con tres campos donde se
// introducirá el día el mes y el año que se desee
...
<html>
<head>
<title>Gobierno Regional de Coquimbo .:::. Calendario</title>
...
//también debe cerrar la ventana del calendario
  ...
  var formulario_destino = '<?echo $HTTP_GET_VARS["formulario"]?>'

  var campo_destino = '<?echo $HTTP_GET_VARS["nomcampo"]?>'
...
$parametros_formulario = "formulario=" . $HTTP_GET_VARS["formulario"] . "&nomcampo=" . $HTTP_GET_VARS["nomcampo"];
?>
...
if (!$_POST && !isset($HTTP_GET_VARS["nuevo_mes"]) && !isset($HTTP_GET_VARS["nuevo_ano"])){
