...
<tr>
 ...
 <td>
   ...
   <table align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#dcdcdc">
     ...
     <tr id=portalhead>
       <td>Hora:</td>
       <td><input type="text" name="seshora" size="5" maxlenght="5" value=$hora onMouseOver='inset(this, 1)' onMouseOut='outset(this,1)' tabindex="4"></td>
     </tr>
     <tr id=portalhead>
...
<tr>
 ...
 <td>
   ...
   <table align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#dcdcdc">
     <tr id=portalhead> <!--  bgcolor=#e3ebe2>  -->
       <td>N&uacute;mero de Sesi&oacute;n:</td>
       <td><input type="text" name="sesname" size="11" maxlength="11"></td>
     </tr>
     <tr id=portalhead>
       <td>Sesi&oacute;n:</td>
...
echo <<< HTML
<!-- <input type="text" name="sesfecha" size="10" maxlength="10">&nbsp; <font size="-1">(dd/mm/aaaa)</font> -->
     ...
     <tr id=portalhead>
       <td>Hora:</td>
       <td><input type="text" name="seshora" size="10" maxlength="5">&nbsp; <font size="-1">(hh:mm)</font></td>
     </tr>

     <tr id=portalhead>
       <td ColSpan="2" align="center" valign="center">
           <input type="submit" name="ses_sub" value=" Crear Nueva Sesión " class="button" onMouseOver='inset(this, 1)' onMouseOut='outset(this,1)' tabindex="4" OnClick="ValidaDatos()">&nbsp;&nbsp;&nbsp;
           <input type="reset" name="ses_res" value=" Descartar " class="button" onMouseOver='inset(this, 1)' onMouseOut='outset(this,1)' tabindex="4">
       </td>
     </tr>
