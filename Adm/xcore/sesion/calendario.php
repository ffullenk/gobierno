...
else
{
	...
	echo "<table width=140 cellspacing=1 cellpadding=1 border=0 bgcolor=#FFFFFF><tr><td colspan=7 align=center class=tit>";
	echo "<table width=100% cellspacing=0 cellpadding=0 border=0 bgcolor=#EAEAEA><tr bgcolor=#C0C0C0><td>";
	...
	echo "<a class=tit href=index.php?dia=1&nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior>&lt;&lt;</a></td>";
	...
	echo "<a class=tit href=index.php?dia=1&nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
...
//escribo la primera fila de la semana
	...
	for ($i=0;$i<7;$i++){
		...
		{			
				...
				{
					echo "<td bgcolor=#EAEAEA align=center><a href=index.php?dia=$dia_actual&nuevo_mes=$mes&nuevo_ano=$ano>$dia_actual</a></td>";
				}
		}
			$dia_actual++;
		}
	...
	while ($dia_actual <= $ultimo_dia){
		...
		//si es el uñtimo de la semana, me pongo al principio de la semana y escribo el </tr>
			...
			{		
				...
				{
					echo "<td align=center bgcolor=#EAEAEA><a href=index.php?dia=$dia_actual&nuevo_mes=$mes&nuevo_ano=$ano>$dia_actual</a></td>";
				}
			}
