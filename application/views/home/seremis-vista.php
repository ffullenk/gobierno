<div id="noticias">
    ...
    <a href="<?php echo BASE_URI?>seremis">Seremis</a>&nbsp;&gt;&nbsp;Seremis Vista </div>
      ...
      <a style="color:#fff;" class="btn-vermas" href="<?php echo BASE_URI?>seremis">Volver</a>
          ...
          <a href="<?php echo BASE_URI?>seremis-vista/<?php echo $e['id'];?>/<?php echo $id?>"><?php echo $e['acronimo'];?></a> | 
            <?php endforeach; ?>

         </p>
		   <br />
		   <h2>Datos Secretar&iacute;a Regional Ministeria </h2>
       <?php foreach($seremis as $s):?>
           ...
           <div id="seremi">
             <table border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td valign="top"><div id="numero-sesion"><strong></strong><img src="<?php echo base_url(); ?>/jefes/fotos/<?php echo $s['foto'];?>" alt=" Secretario Regional Ministerial" width="75" height="90" align="left" border="1" />
