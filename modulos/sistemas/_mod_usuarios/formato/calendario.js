...
function showCalendar(textbox,lang){
	...
	if(obj!=null){
		...
		if(lang=="US"||lang=="us"){
			...
			months=Array('Januar','Februar','März','April','Mag','Juni','Juli','August','September','Oktober','November','Dezember');
			var month=txt.substring(3,5);
			var year=txt.substring(6,10);
		}else if(lang=="FR"||lang=="fr"){
			weeks=Array('dim','lun','mar','mer','jeu','ven','sam');
			months=Array('Janvier','Février','Mars','Avril','Peut','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre');
			var month=txt.substring(3,5);
			var year=txt.substring(6,10);
		}else if(lang=="ES"||lang=="es"){
			weeks=Array('dom','lun','mar','mié','jue','vie','sáb');
			months=Array('Enero','Febrero','Marzo','Abril','Mayo','Junio','Julio','Agosto','Septiembre','Octubre','Noviembre','Diciembre');
			var month=txt.substring(3,5);
			var year=txt.substring(6,10);
		}else if(lang=="PT"||lang=="pt"||lang=="BR"||lang=="br"){
			weeks=Array('dom','seg','ter','qua','qui','sex','sáb');
			months=Array('Janeiro','Fevereiro','Março','Abril','Pode','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro');
			var month=txt.substring(3,5);
			var year=txt.substring(6,10);
		}	
