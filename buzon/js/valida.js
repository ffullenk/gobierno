...
var espacios=" \t\n\r";
var fonos="()-+ ";
var mMessage="Error: No puede dejar este espacio vacío."
var pPrompt="Error: ";
...
var pDate="Ingrese una fecha válida (aa-mm-dd).";
...
/**
 * Determina si el string 's' (en formato 'dd-mm-aa') es una fecha válida.
*/
function isDate(s)
{
	var guiones=0;
