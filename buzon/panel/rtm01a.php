								...
								<tr>
									...
									<div id="paginacion">
							          ...
							          <?php $nombre_tema	= $_POST["TEMA"]; ?>
										...
										<tr><td>
											<FORM ACTION="bz_tm01a1.php" METHOD="post" NAME="formulario" onSubmit="return vldformTema();">
											...
											<TR class="texto-contenido">
												<TD>&nbsp;Rut</TD>
												<TD width="70%">
												<input name="Tema" type="text" tabindex="1" value="<?php echo $nombre_tema;?>" size="50" maxlength="128"> 
												</TD>
											</TR>
											<TR><TD colspan="2">&nbsp;</TD></TR>
											<TR class="texto-tablas"> 
												<TD colspan="2"> &nbsp;<strong>Selecci&oacute;n de Funcionario Responsables para Responder Emails</strong></TD>
											</TR>
											<TR class="texto-contenido"> 
												<TD colspan="2">
												...
												<span class="formAsterisco">(*). Utilice la tecla Control (Ctrl) para seleccionar m&aacute;s de uno.</span></TD>
											</TR>
											</TABLE>
											<div align="center">
												<br>
