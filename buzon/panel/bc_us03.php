          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <?
					  ...
					  /* examino la página a mostrar y el inicio del registro a mostrar */
						...
						$ssql = "SELECT COD_FUNCIONARIO, NOMBRES, APPAT, APMAT FROM FUNCIONARIO WHERE TIPO_FUNCIONARIO = \"3\" ORDER BY APPAT DESC";
						$rs = mysql_query($ssql);
            ...
            <tr> 
              ...
              <td><form id="formlist" method="post" action="bc_us01m.php">
                  <?php echo "<input name=\"id\" type=\"hidden\" value=\"$fila->COD_FUNCIONARIO\"/>
					<input name=\"TiUs\" type=\"hidden\" value=\"3\"/>";?> 
