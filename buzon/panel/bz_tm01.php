                    ...
                    <tr>
                      ...
                      <td width="560" valign="top">
					    <!-- Seccion Central -->
                          ...
                          <tr>
                            <td class="textoRuta"><?php Ruta("T");?></td>
                          </tr>
								...
								<tr>
									...
									<div id="paginacion">
										...
										<?php
											...
											/*  */
											$ssql = "SELECT COD_TEMA, TEMA, ACTIVADO FROM TEMAS ORDER BY TEMA DESC";
											...
											if( $num_total_registros > 0 ) {
												...
												<tr valign="middle" bgcolor="<?php echo $color;?>">
													...
													<td align="center">
														<form id="formlist" method="post" action="bz_tm01m.php">
													...
													<td align="center">
<form id="formlist" method="post" action="bz_tm01e.php">
<input type="hidden" name="id" value="<?php echo $rsSQL->FieldByNumber(0);?>">
<input type="hidden" name="estado" value="<?php echo $rsSQL->FieldByNumber(2);?>">
<?php echo "<input name=\"TiUs\" type=\"hidden\" value=\"1\"/>";?>
<input type="hidden" name="global_qk" value="<?php echo $global_qk;?>">

<input type="image" src="../imagenes/<?php if($rsSQL->FieldByNumber(2)=="S") { echo "ic_delete.gif"; } else {echo "okBD.gif";}?>" align="absmiddle" title="<?php if($rsSQL->FieldByNumber(2)=="S") { echo "Desactivar";} else { echo "Activar";}?> Tema" size="28,28" border="0" />												
														</form>
													</td>
												</tr>
<?php										} ?>
