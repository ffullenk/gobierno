                    ...
                    <tr>
                      ...
                      <td width="560" valign="top">
					    <!-- Seccion Central -->
                          ...
                          <tr>
                            <td class="textoRuta"><?php Ruta("UR");?></td>
                          </tr>
                          ...
                          <tr>
							...
							<!-- Parte  Central de la Pagina-->
								...
								<tr>
									<td>
									<div id="maincol" >
										<h1>Usuario Responsable Responder Emails</h1>
									    <div align="right">
											<form id="formlist" name="f_agrega" method="post" action="bz_us01a.php">
												<?php echo "<input name=\"TiUs\" type=\"hidden\" value=\"2\"/>";?> 
									...
									<div id="paginacion">
										...
										<?php
											...
											/*  */
$ssql = "SELECT COD_FUNCIONARIO, concat(NOMBRES, ' ',APPAT, ' ',APMAT), ACTIVADO 
FROM FUNCIONARIO WHERE TIPO_FUNCIONARIO = \"2\" ORDER BY APPAT DESC";
											...
											if( $num_total_registros > 0 ) {
												...
												<?php $color=($color==""?"#efefef":""); ?>
												<tr valign="middle" bgcolor="<?php echo $color;?>">
													<td class="texto-contenido" >
														<?php echo $rsSQL->FieldByNumber(1);?></td>
													<td align="center">
														<form id="formlist" method="post" action="bz_us01m.php">
															<input type="hidden" name="id" value="<?php echo $rsSQL->FieldByNumber(0);?>">
															<?php echo "<input name=\"TiUs\" type=\"hidden\" value=\"2\"/>";?>
														<input type="hidden" name="global_qk" value="<?php echo $global_qk;?>">
															<input type="image" src="../imagenes/ic_edit.gif" align="absmiddle" value=" Editar " title=" Modificar Datos Usuario" size="28,28" border="0" />												
														</form>
													</td>
													<td align="center">

   <form id="formlist" method="post" action="bz_us01e.php">
		<input type="hidden" name="id" value="<?php echo $rsSQL->FieldByNumber(0);?>">
		<input type="hidden" name="estado" value="<?php echo $rsSQL->FieldByNumber(2);?>">
		<?php echo "<input name=\"TiUs\" type=\"hidden\" value=\"2\"/>";?> 
		<input type="hidden" name="global_qk" value="<?php echo $global_qk;?>">
		
		<input type="image" src="../imagenes/<?php if($rsSQL->FieldByNumber(2)=="S") { echo "ic_delete.gif"; } else {echo "okBD.gif";}?>" align="absmiddle" title="<?php if($rsSQL->FieldByNumber(2)=="S") { echo "Desactivar";} else { echo "Activar";}?> Usuario" size="28,28" border="0" />												
	</form>
													</td>
												</tr>
<?php										} ?>
