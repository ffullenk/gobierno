...
<div id="content"> 
        ...
        <div id="agregaADM"> 
          ...
          <TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" BORDERCOLOR="#F1F1F1" MM_NOCONVERT="TRUE">
            <TR> 
              <TD align="center"> <FORM ACTION="bz_tc01a1.php" METHOD="post" NAME="formulario" onSubmit="return vldformTipo();">
                  <TABLE WIDTH="90%" BORDER="1" CELLPADDING="0" cellspacing="0" bordercolor="#EEEEEE">
                    <TR class="cabecera_titulo"> 
                      <TD colspan="2">Formulario de Ingreso Tipo de Solicitud</TD>
                    </TR>
                    <TR> 
                      <TD WIDTH="30%">&nbsp;Tipo</TD>
                      <TD><input name="nombre_tipo"  type="text"   tabindex="1" value="<?php echo $nombre_tipo;?>" title=" Nueva Temática a incluir" size="50" maxlength="15"> 
                  ...
                  <input type="submit" name="enviar" title="Agregar Nuevo Tipo de Solicitud" value=" Agregar " tabindex="2">
                  &nbsp; 
                  <input type="RESET"  name="limpiar" title="Restablecer formulario" value=" Limpiar "  tabindex="3">
                </FORM></TD>
            </TR>
          </TABLE>
		  </div>
