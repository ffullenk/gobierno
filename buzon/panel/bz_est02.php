                          ...
                          <tr>
							...
							<!-- Parte  Central de la Pagina-->
								...
								<tr>
									<td>
									<div id="maincol" >
										<h1>Total Hombres y Mujeres Registrados en el Sitio</h1>
									    <div align="right">
											<!-- no hay agregar -->
										</div>
									</div><!-- FIN MAINCOL -->
...
$ssql = "SELECT SUM(  IF ( GENERO =  \"M\", 1, 0 ) )  AS Hombres, 
			SUM(  IF ( GENERO =  \"F\", 1, 0 ) )  AS Mujeres, 
			SUM( 1  )  AS TOTAL 
			FROM PERSONA";
$rsSQL->Open($ssql);
$conthit=0;
...
{$conthit++;
$encres=$rsSQL->FieldByNumber(2);

$enchit=$rsSQL->FieldByNumber(0); //Hombres
$hit[$conthit]=$enchit;  //repondidas
$totenchit+=$enchit; 	// respondidas

$noresp=$rsSQL->FieldByNumber(1);	//Mujeres
...
?>
								...
								<tr><td class="texto-contenido"><strong>Simbolog&iacute;a</strong>:<br />
										<img src="../imagenes/barra_nr.jpg" width="15" height="15"> Femenino <br />
										<img src="../imagenes/barra_sr.jpg" width="15" height="15"> Masculino <br />
									</td>
								</tr>
								</table>
							<!-- Parte  Central de la Pagina-->
