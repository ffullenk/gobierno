										...
										if($contador_error>0) { 
											...
											if ($error == true ) { ?>
												<table width="550" border="0" align="center">
													<tr><td height="5" colspan="2"></td></tr>
													<tr class="informa">
														<td colspan="2"><img src="../imagenes/ic_ok.jpg">&nbsp;El Registro de usuario se ha realizado con éxito.</td>
													</tr>
													<tr class="informa-texto">
														<td colspan="2">El nombre de usuario y contraseña serán enviado a su email.</td>
													</tr>
													<?php
													echo "
