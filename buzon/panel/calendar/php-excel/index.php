          ...
          <td>
              ...
              <table border="0" cellspacing="0" cellpadding="2">
                <tr>
				  ...
				  ?></td>
        <td><input type="submit" name="button" id="button" value="Ver Fechas" onClick="javascript:alert(this.form.date5.value); javascript:alert(this.form.date6.value);"></td>
         <tr>
...
AND SUBSTRING(BITACORA_C.FECHA,1,10) BETWEEN '$vari1' AND '$vari2'";
