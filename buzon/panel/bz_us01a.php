                          ...
                          <tr>
							...
							<!-- Parte  Central de la Pagina-->
								...
								<tr>
									<td>
									<div id="maincol" >
										<h1>Agregar Usuario <?php
										if($TiUs == "1" ) { echo "Administrador";}
										elseif($TiUs == "2" ) { echo "Responsable Responder Emails";}
										else echo "Consultas"; ?> </h1>
									    <div align="right">
...
<?php
				...
				$confirmarpassword_persona	= $_POST["confirmarpassword_persona"];?>				
										...
										<table width="550" border="0" align="center">
											...
											<tr>
												<td>
													<form action="bz_us01a1.php" method="post" name="formulario" id="FMuestra" onSubmit="return vldformUsuario();">
													<?php echo "<input name=\"TiUs\" type=\"hidden\" value=\"$TiUs\"/>";?> 
													...
													<TR class="texto-contenido"> 
														...
														<TD>
														<input name="confirmarpassword_persona" type="password" tabindex="8" onBlur="" value="<?php echo $confirmarpassword_persona;?>"  size="30" maxlength="25"> 
														<span class="formAsterisco">(*)</span></TD>
													</TR>
													</TABLE>
													<div align="center">
													...
													<input type="submit" name="enviar" title="Agregar datos del Funcionario" value=" Grabar " tabindex="9" class="btn" onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'">
													&nbsp; 
