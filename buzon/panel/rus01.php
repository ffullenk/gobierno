                    ...
                    <tr>
                      ...
                      <td width="560" valign="top">
					    <!-- Seccion Central -->
                          ...
                          <tr>
                            <td class="textoRuta"><?php Ruta("U");?></td>
                          </tr>
								...
								<tr>
									...
									<div id="paginacion">
										...
										<?php
											...
											/*  */
											$ssql = "SELECT COD_FUNCIONARIO, concat(NOMBRES, ' ',APPAT, ' ',APMAT)  
														FROM FUNCIONARIO 
														WHERE TIPO_FUNCIONARIO = \"1\" 
														ORDER BY APPAT DESC";
												...
												<tr valign="top">
													...
													<td>
														...
														<input type="hidden" name="global_qk" value="<?php echo $global_qk;?>">
															<input type="image" src="../imagenes/ic_edit.jpg" value=" Editar " size="28,28" border="0" />												
														</form>
													</td>
													<td>
														<form id="formlist" method="post" action="bz_us01e.php">
															...
															<?php echo "<input name=\"TiUs\" type=\"hidden\" value=\"1\"/>";?> 
														<input type="hidden" name="global_qk" value="<?php echo $global_qk;?>">
															<input type="image" src="../imagenes/ic_delete.jpg" value=" Editar " size="28,28" border="0" />												
														</form>
													</td>
												</tr>
												<tr ><td height="5" colspan="3"></td></tr>
