...
<div id="pagewidth" >
  ...
  <div id="header" > Cabecera </div>
          ...
          <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <?
					  ...
					  /* examino la página a mostrar y el inicio del registro a mostrar */
						...
						$ssql = "SELECT COD_FUNCIONARIO, NOMBRES, APPAT, APMAT FROM FUNCIONARIO WHERE TIPO_FUNCIONARIO = \"2\" ORDER BY APPAT DESC";
						$rs = mysql_query($ssql);
            ...
            <tr> 
              <td><strong><em><?php echo $fila->APPAT . " " . $fila->APMAT . " " . $fila->NOMBRES;?></em></strong></td>
              <td><form id="formlist" method="post" action="bc_us01m.php">
                  <input type="hidden" name="id" value="<?php echo $fila->COD_FUNCIONARIO;?>">
                  <input type="submit" value="Modificar"class="btn" onmouseover="this.className='btn btnhov'" onmouseout="this.className='btn'">
                </form></td>
              <td><form id="formlist" method="post" action="bc_us01e.php">
                  <input type="hidden" name="id" value="<?php echo $fila->COD_FUNCIONARIO;?>">
	...
	<div id="footer" >
		www.gorecoquimbo.cl: Servicio Administrativo Gobierno Regional de Coquimbo, Departamento de Informatica &copy; 2005 
	</div>
</div>
</body>
